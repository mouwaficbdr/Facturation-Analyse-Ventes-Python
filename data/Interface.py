...
class FacturationApp:
    ...
    def create_sidebar(self):
        ...
        self.menu_items = {
            ...
            'Statistiques': self.StatisquesMotion,
        }
    ...
    def productMotion(self, parent):
        ...
        # Bouton Ajouter
        ajouter_btn = tk.Button(form_frame, text=" +  Ajouter le produit", bg="black", fg="white", font=("Roboto", 10, "bold"), padx=10, pady=10, relief="flat", cursor="hand2")
